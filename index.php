      ...
      <div class="row d-flex align-items-center justify-content-center h-100">
        ...
        <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
          <form action="login.php" method="post">
            <p class="text-center h1 fw-bold mb-4 mx-1 mx-md-3 mt-3">تسجيل  </p>
            <!-- Email input -->
          ...
          <p align="center">ليس لدي اي حساب  <a href="register.php" class="text-warning" style="font-weight:600;text-decoration:none;">تسجيل جديد</a></p>
        </div>
      </div>
    </div>
  </section>
