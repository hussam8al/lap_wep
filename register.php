            ...
            <header>
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="rr.html">حول المتجر</a></li>
                        <li><a href="mm.html">اتصل بنا</a></li>
        ...
        <div class="col-lg-12 col-xl-11">
          <div class="card text-black" style="border-radius: 25px;">
            <div class="card-body p-md-2">
              ...
              <p class="text-center h1 fw-bold mb-4 mx-1 mx-md-3 mt-3">اشتراك </p>
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <form class="mx-1 mx-md-4" action="add.php" method="post">
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example1c"><i class="bi bi-person-circle"></i> اسمك </label>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example3c"><i class="bi bi-envelope-at-fill"></i> بريدك الاكتروني</label>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example4c"><i class="bi bi-chat-left-dots-fill"></i> كلمة السر </label>
                  ...
                  <p align="center">لدي حساب مسبقا<a href="index.php" class="text-warning" style="font-weight:600; text-decoration:none;">نسجيل دخول </a></p>
                </div>
